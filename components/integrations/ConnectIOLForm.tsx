  ...
  return (
    <div className="mt-3 space-y-3">
      <div className="flex items-start gap-2 bg-blue-950/30 border border-blue-900/40 rounded-xl px-3 py-2.5">
        ...
        <div className="space-y-0.5">
          ...
          <p className="text-[10px] text-blue-400/70 leading-snug">
            IOL no permite crear credenciales con permisos limitados. Usamos tu usuario y contraseña únicamente para leer tu portafolio. Nunca llamamos endpoints de compra, venta ni transferencias.
          </p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        <div>
          <label className="text-xs text-bf-text-3 mb-1 block">Usuario IOL</label>
          <input
            type="text"
            value={username}
