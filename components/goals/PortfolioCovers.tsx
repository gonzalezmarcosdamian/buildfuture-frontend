      ...
      <div className="flex items-end justify-between">
        <div>
          ...
          <p className="text-[11px] text-slate-400">
            Rendimiento mensual:{" "}
            <span className="text-emerald-400 font-semibold">+USD {monthly_return_usd.toFixed(0)}/mes</span>
          </p>
        </div>
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center justify-between gap-2">
                ...
                <p className="text-[10px] text-slate-500 shrink-0">{formatUSD(item.amount_usd)}/mes</p>
              </div>
              {item.status === "partial" && (
                <div className="mt-1.5">
                  ...
                  <p className="text-[9px] text-yellow-500 mt-0.5">{(item.covered_pct * 100).toFixed(0)}% cubierto</p>
                </div>
              )}
            </div>
